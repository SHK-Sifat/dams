                ...
                <div class="col-md-2 sidebar_part">
                    ...
                    <div class="menu">
                        <ul>
                            ...
                            <li><a href="{{url('dashboard/department')}}"><i class="fas fa-user-circle"></i> Department</a></li>
                            <li><a href="{{url('dashboard/doctor')}}"><i class="fas fa-user-circle"></i> Doctors</a></li>
                            <li><a href="{{url('dashboard/patient')}}"><i class="fas fa-user-circle"></i> Patient</a></li>
